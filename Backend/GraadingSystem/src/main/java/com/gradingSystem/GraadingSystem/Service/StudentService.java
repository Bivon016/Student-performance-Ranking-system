...
public class StudentService {
    ...
    public void deleteStudent(Long id){
      ...
      Students student = studentRepo.findById(id).orElseThrow(()->new ResponseStatusException(HttpStatus.NOT_FOUND,"Student not found"));
    ...
    public Students updateStudents(Long id,Students newData){
        Students student = studentRepo.findById(id).orElseThrow(() ->new ResponseStatusException(HttpStatus.NOT_FOUND, "Student does not exist"));
        student.setFirstName(newData.getFirstName());
        student.setSecondName(newData.getSecondName());
        student.setForm(newData.getForm());
